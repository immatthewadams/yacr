...
var RoomList = React.createClass({displayName: "RoomList",
    render: function() {
        var rooms = this.state.rooms.map(function(room) {
            return (
                React.createElement("div", null, 
                    React.createElement("a", {href: "#"}, room)
                )
            );
        });
        ...
        return (
            React.createElement("div", null, 
                React.createElement("h1", null, "Chat rooms"), 
                rooms, 
                React.createElement("form", {onSubmit: this.postRoom, className: "input-group"}, 
                    React.createElement("input", {placeholder: "Chat room name", ref: "name", type: "text", className: "form-control"}), 
